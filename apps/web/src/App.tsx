...
export default function App() {
  ...
  return <div className="shell">
    ...
    <main>
      ...
      {tab === "settings" && <><section className="panel setup-panel"><div className="panel-title"><div className="icon cyan"><Link/></div><div><h2>Companion address</h2><p>Change this only if Home Assistant is not available at its default local address.</p></div></div><div className="form"><Field label="HomeCue Companion URL"><input type="url" value={companionUrl} onChange={e => setCompanionUrl(e.target.value)}/></Field></div></section><div className="section-label">Manual connection</div><section className="panel-grid">
