...
import { Boxes, Cable, Check, Gauge, Home, Lightbulb, Play, RotateCw, Save, Settings2, Square, Wifi } from "lucide-react";
import { defaults, getServiceStatus, loadInventory, loadSettings, saveSettings, startService, stopService, type Inventory, type ServiceStatus, type Settings } from "./bridge";
